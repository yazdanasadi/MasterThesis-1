...
python train_FLD.py -d physionet -ot 24 -bs 32 -e 100 -es 30 --gpu $GPU -fn S --tbon --logdir $LOGDIR
"@

# FLD-ICC (run from FLD_ICC/)
Run-JobAt "FLD_ICC_physionet" "FLD_ICC" @"
python train_FLD_ICC.py -d physionet -ot 24 -bs 32 --epochs 100 --early-stop 30 --gpu $GPU -fn S -ed 64 -ld 64 -nh 2 --tbon --logdir $LOGDIR
"@

# GraFITi (run from grafiti/)
Run-JobAt "GraFITi_physionet" "grafiti" @"
python train_grafiti.py -d physionet -ot 24 -bs 32 --epochs 100 --early-stop 30 --gpu $GPU --encoder gratif --tbon --logdir $LOGDIR
"@

# mTAN (run from mtan/)
Run-JobAt "mTAN_physionet" "mtan" @"
python train_mtan.py -d physionet -ot 24 -bs 32 --niters 100 --early-stop 30 --gpu $GPU --latent-dim 16 --rec-hidden 32 --gen-hidden 50 --embed-time 128 --k-iwae 10 --lr 1e-3 --tbon --logdir $LOGDIR
"@
